...
//#define OPT_CATEGORY     'O' // Conflict with master of svn. They now use 'O'
#define OPT_COPYWARNING  'Q'
#define OPT_STUDIO       'U'
#define OPT_YRATING      'Y'
#define OPT_RANNOTATION  'V'
#define OPT_CRATING      'X'
//#define OPT_RATING       'X' // Conflict with master of svn. They now use 'X'
    ...
    main( int argc, char** argv )
{
    const prog::Option long_options[] = {
        ...
        { "rating",      prog::Option::REQUIRED_ARG, 0, OPT_YRATING      },
    ...
    while ( prog::optind < argc ) {
        ...
        if ( ELEMENT_OF(tags, OPT_YRATING)) {
          char **lista;
          int i = 0;
          ...
          const char *rating = ELEMENT_OF(tags, OPT_YRATING);
